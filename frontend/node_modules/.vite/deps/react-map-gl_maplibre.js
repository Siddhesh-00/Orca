...
function getTransformLike(map) {
  ...
  return {
    ...
    elevation: ((_a = map.getCenterElevation) == null ? void 0 : _a.call(map)) ?? 0,
...
function updateConstraint(nextRange, currentRange, setMin, setMax) {
...
function updateZoomConstraint(map, nextRange, currentRange) {
  return updateConstraint(nextRange, currentRange, (v) => map.setMinZoom(v), (v) => map.setMaxZoom(v));
}
function updatePitchConstraint(map, nextRange, currentRange) {
  return updateConstraint(nextRange, currentRange, (v) => map.setMinPitch(v), (v) => map.setMaxPitch(v));
}
...
var settingNames = ["maxBounds", "projection", "renderWorldCopies"];
var handlerNames = [
  "scrollZoom",
  "boxZoom",
  "dragRotate",
...
var Maplibre = class _Maplibre {
  ...
  /* Update camera constraints to match props
     ...
     @returns {bool} true if anything is changed
   */
  _updateConstraints(nextProps, currProps) {
    const didUpdateZoom = updateZoomConstraint(this._map, {
    ...
    const didUpdatePitch = updatePitchConstraint(this._map, {
...
function _Map(props, ref) {
  ...
  (0, import_react3.useEffect)(() => {
    ...
    let isMounted = true;
    let maplibre;
    Promise.resolve(mapLib || import("./maplibre-gl-TH6I3PM5.js")).then((module) => {
      if (!isMounted) {
        return;
      }
      if (!module) {
...
// node_modules/@vis.gl/react-maplibre/dist/components/globe-control.js
var import_react14 = __toESM(require_react(), 1);
function _GlobeControl(props) {
  const ctrl = useControl(({ mapLib }) => {
    const GlobeControl2 = mapLib.GlobeControl;
    if (!GlobeControl2) {
      throw new Error("GlobeControl is not supported by this version of MapLibre GL JS");
    }
    return new GlobeControl2(props);
  }, {
    position: props.position
  });
...
var GlobeControl = (0, import_react14.memo)(_GlobeControl);
...
function Source(props) {
  ...
  const id = (0, import_react15.useMemo)(() => props.id || `jsx-source-${sourceCounter++}`, []);
  ...
  propsRef.current = props;
  return source && React4.Children.map(props.children, (child) => child && (0, import_react15.cloneElement)(child, {
    source: id
  })) || null;
}
...
function Layer(props) {
  ...
  const id = (0, import_react16.useMemo)(() => props.id || `jsx-layer-${layerCounter++}`, []);
